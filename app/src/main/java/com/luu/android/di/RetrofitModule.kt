...
import com.luu.android.data.remote.InterceptorImpl
...
fun provideInterceptor(userRepository: UsersRepository): Interceptor {
    return InterceptorImpl(userRepository)
}